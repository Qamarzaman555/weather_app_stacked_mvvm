                            ...
                            Card(
                              ...
                              child: Container(
                                ...
                                child: ListView.separated(
                                  ...
                                  itemCount:
                                      viewModel.dataList.first.days!.length,
                                    ...
                                    return Column(
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Text(
                                              viewModel.dataList.first.days!
                                                  .first.hours![index].temp!
                                                  .toInt()
                                                  .toString(),
                                              style: Theme.of(context)
                                                  .textTheme
                                ...
                                child: ListView.separated(
                                  ...
                                  itemBuilder: (context, index) {
                                    return Row(
                                      ...
                                      children: [
                                        Text(
                                          Utils.extractDay(viewModel.dataList
                                            ...
                                            child: Container(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    '${viewModel.weather[index].condName}',
                                                    style: Theme.of(context)
                                                        .textTheme
                                                        .labelLarge
                                                        ?.copyWith(
                                  ...
                                  children: [
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          Utils.formateTime(viewModel.dataList
